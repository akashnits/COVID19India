 ...
 */
object AppInjector {
    fun init(COVID19App: COVID19App){
        DaggerAppComponent.builder()
            .application(COVID19App)
            .build().inject(COVID19App)

        COVID19App.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks{
